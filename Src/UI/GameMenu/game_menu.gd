...
const INVENTORY_ITEMS := [
	{
		...
		"description": "A loose strand resonant with primordial Power.",
	...
	},
	{
		"id": &"balance",
		"category": &"key_items",
		"name": "FRAGMENT OF BALANCE",
		"description": "A loose strand resonant with primordial Balance.",
	...
	},
	{
		"id": &"essence",
		"category": &"key_items",
		"name": "FRAGMENT OF ESSENCE",
		"description": "A loose strand resonant with primordial Essence.",

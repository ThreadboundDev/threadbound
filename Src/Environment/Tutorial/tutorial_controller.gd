...
@export var hp_spotlight_rect := Rect2(188.0, 118.0, 340.0, 92.0)
@export var hp_pointer_start := Vector2(610.0, 220.0)
@export var hp_pointer_end := Vector2(450.0, 154.0)
@export var action_points_spotlight_rect := Rect2(24.0, 14.0, 170.0, 300.0)
@export var action_points_pointer_start := Vector2(560.0, 260.0)
@export var action_points_pointer_end := Vector2(128.0, 118.0)

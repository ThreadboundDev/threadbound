...
@export var hp_spotlight_rect := Rect2(222.0, 104.0, 426.0, 48.0)
...
@export var momentum_spotlight_rect := Rect2(224.0, 146.0, 414.0, 32.0)
@export var momentum_pointer_start := Vector2(610.0, 188.0)
@export var momentum_pointer_end := Vector2(430.0, 162.0)
@export var thread_knot_spotlight_rect := Rect2(1528.0, 946.0, 384.0, 122.0)
@export var thread_knot_pointer_start := Vector2(1040.0, 810.0)
@export var thread_knot_pointer_end := Vector2(1720.0, 1004.0)

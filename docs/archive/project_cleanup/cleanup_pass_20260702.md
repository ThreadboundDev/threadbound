...
- `docs/archive/project_cleanup/asset_reference_audit_20260702.json`
- `docs/archive/project_cleanup/delete_candidates_20260702/static_unreferenced_assets.csv`
- `docs/archive/project_cleanup/delete_candidates_20260702/top_review_candidates.json`

...
at `docs/archive/project_cleanup/quarantine_manifest_20260725.json`.
...
The previous `docs/archive/project_cleanup/delete_candidates_20260702/` staging folder was
